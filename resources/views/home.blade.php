            ...
            <p class="lead lead-lg" style="text-transform: capitalize;">
                <ol class="breadcrumb d-flex justify-content-center" style="height: 40px;">
                    <li class="breadcrumb-item active text-white">
                        ...
                        {{ Auth::user()->name }} - {{ App\Models\Role::where('name', Auth::user()->role)->first()->display_name }}
                    </li>
                </ol>
            </p>
            <br>
        ...
        <div class="col-md-7">
            <div class="card card-primary" style="min-height: 350px;">
                <ul class="nav nav-tabs  shadow-2dp" role="tablist">
                    @role(['company-admin'])<li class="nav-item"><a class="nav-link withoutripple active" href="#companies" aria-controls="companies" role="tab" data-toggle="tab"><i class="fa fa-address-book"></i> <span class="d-none d-sm-inline"> My Group Profile </span></a></li>@endrole
                    
                    @role(['company-admin','salon-admin'])<li class="nav-item"><a class="nav-link withoutripple" href="#salons" aria-controls="salons" role="tab" data-toggle="tab"><i class="zmdi zmdi-male-female"></i> <span class="d-none d-sm-inline"> My Salons(s)/Spa's</span></a></li>@endrole
                ...
                <div class="card-body">
                    <div class="tab-content">
                        @role(['company-admin'])<div role="tabpanel" class="tab-pane fade active show" id="companies">
                                            ...
                                            <tr>
                                                ...
                                                <td class="row text-center mt-1" style="min-width: 115px; border: none;">
                                                    <div class="row">
                                                        ...
                                                        <a href="{{ route('companies.edit', ['all',$company->id]) }}" class="col-5 btn btn-sm btn-primary" style="font-size: 13px;"><i class="fa fa-edit" title="Edit Company"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
                                        <tr>
                                            <td colspan="6" style="vertical-align: middle;">
                                                <a href="{{ route('companies.index','all') }}">
                                                    <button class="btn btn-sm btn-default btn-info">All Companies</button>
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
