            ...
            <div class="card animated fadeInUp animation-delay-7 color-primary withripple">
	            <div class="card-body-big color-dark">
	                <div class="text-center">
	                  	<h1 class="color-primary">419</h1>
	                  	<h2>Page Expired</h2>
	                  	<p class="lead lead-sm">The resource took long without activity and the session expired<br>Try reloading the page or another resource.</p>
