            ...
            <div class="card animated fadeInUp animation-delay-7 color-primary withripple">
	            <div class="card-body-big color-dark">
	                <div class="text-center">
	                  	<h1 class="color-primary">500</h1>
	                  	<h2>Internal Server Error</h2>
	                  	<p class="lead lead-sm">Theere has been a temporary server error<br>Our Robots are at work. Ypu can as well contact the Admins.</p>
